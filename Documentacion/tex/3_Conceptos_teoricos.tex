...
\begin{enumerate}
    \item \say{La habilidad, como sistema, de interpretar correctamente datos externos, aprender de estos datos, y usar lo aprendido para lograr objetivos y tareas concretas a través de una adaptación flexible} \cite{kaplan_haenlein_2019}.
    \item \say{... la habilidad de un sistema de actuar adecuadamente en un ecosistema incierto en el que la acción apropiada es la que aumenta la probabilidad de alcanzar el objetivo, siendo el objetivo completar una serie de logros menores que ayuden a alcanzar el objetivo final} \cite{albus_1991}.
    \item \say{Estudio de del diseño de agentes inteligentes} \cite{poole_mackworth_goebel_1998}.
\end{enumerate}
