...
\newcommand{\nombre}{Daniel Arnaiz Gutierrez} %%% cambio de comando

% Datos de portada
\title{Extracción y procesamiento de datos de Amazon para su utilización en un estudio de marketing.}
\author{\nombre}
\tutor{Dr. José Francisco Díez Pastor \\ Dr. César Ignacio García Osorio}
\date{\today}
...
\noindent Dr. José Francisco Díez Pastor y Dr. César Ignacio García Osorio, profesores del departamento de Ingeniería Civil, área de Lenguajes y sistemas informáticos.

\noindent Exponen:

\noindent Que el alumno D. \nombre, con DNI 71296333, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado <<Extracción y procesamiento de datos de Amazon para su utilización en un estudio de marketing>>. 
...
\begin{abstract}
Minería de datos, \english{Web scraping}, Clasificador, Base de datos, Redes neuronales, Inteligencia artificial
\end{abstract}
...
\begin{abstract}
Data mining, Web scraping, Classifier, Database, Neuronal network, Artificial intelligence
\end{abstract}
